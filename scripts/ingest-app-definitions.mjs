  ...
  [
    ...
    [
      method(
        ...
        "S3",
        "Connect a Slack workspace and limit access to the channels agents need. In your Slack app, add these scopes under User Token Scopes (not Bot Token Scopes), and add Paperclip's callback URL as a Redirect URL.",
        {
          label: "Use this connection as an agent tool",
          purpose: "tool",
          ownershipModes: ["customer"],
